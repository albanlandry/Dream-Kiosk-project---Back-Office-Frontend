    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          showError(
            error.response?.data?.message || '비디오 업로드에 실패했습니다.',
          );
        } finally {
          setUploading(false);
        }
          ...
          <form onSubmit={handleUpload} className="space-y-6">
              ...
              >
                ...
                {file ? (
                  <div className="space-y-2">
                    <i className="fas fa-video text-4xl text-green-500"></i>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="비디오에 대한 설명을 입력하세요 (선택사항)"
                maxLength={500}
              />
            </div>
